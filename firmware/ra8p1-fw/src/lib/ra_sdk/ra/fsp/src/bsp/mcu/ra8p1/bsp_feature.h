...
#define BSP_FEATURE_DMAC_SUPPORT_TRANSFER_8_BYTE                        (1UL)           // DMAC Support 64 bit transfer size.

#define BSP_FEATURE_DOC_IS_AVAILABLE                                    (1UL)
#define BSP_FEATURE_DOC_VERSION                                         (2UL)           // The version of the DOC peripheral.

#define BSP_FEATURE_DTC_SUPPORT_TRANSFER_8_BYTE                         (1UL)           // DTC Support 64 bit transfer size.
...
#define BSP_FEATURE_ESWM_PSFP_METER_FILTER_DOUBLE_BUCKET_METERS_MAX_NUM (8UL)           // Maximum number of PSFP Meter filter which supports double bucket meters.
#define BSP_FEATURE_ESWM_PSFP_METER_FILTER_SINGLE_BUCKET_METERS_MAX_NUM (32UL)          // Maximum number of PSFP Meter filter.
#define BSP_FEATURE_ESWM_PSFP_MSDU_FILTER_MAX_NUM                       (16UL)          // Maximum number of PSFP MSDU filter.
...
#define BSP_FEATURE_GPT_AD_CONVERSION_START_CHANNEL_MASK                (0x3FFFUL)      // Mask of GPT channels supporting A/D conversion start.
...
#define BSP_FEATURE_GPT_COMPLEMENTARY_SUPPORTED                         (1UL)           // Complementary PWM is supported.
...
#define BSP_FEATURE_LPM_HAS_DSLPWUPIRQEN0                               (1UL)           // The DSLPWUPIRQEN0 registers are available.
#define BSP_FEATURE_LPM_HAS_DSLPWUPIRQEN1                               (1UL)           // The DSLPWUPIRQEN1 registers are available.
#define BSP_FEATURE_LPM_HAS_DSLPWUPIRQEN2                               (1UL)           // The DSLPWUPIRQEN2 registers are available.
